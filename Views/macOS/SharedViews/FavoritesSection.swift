...
struct FavoritesSection: View {
    ...
    private func contextMenu(for item: FavoriteItem) -> some View {
        ...
        if case let .track(track) = item.itemType {
            Button {
        ...
        case .podcastShow:
            ...
            Divider()
        case .track:
            // Tracks don't need a "View" button, they play on tap
            EmptyView()
        }
...
private struct FavoriteItemCard: View {
    ...
    private var thumbnail: some View {
        ...
        .overlay {
            ...
            if case .track = self.item.itemType, self.isHovering {
                Circle()
