...
class QueueTableCellView: NSView {
    ...
    func configure(track: Track, index: Int, isCurrentTrack: Bool, isPlaying: Bool, actions: QueueCellActions) {
        ...
        self.artistLabel.stringValue = track.artistsDisplay.isEmpty ? "Unknown Artist" : track.artistsDisplay
        ...
        if let url = track.thumbnailURL?.highQualityThumbnailURL {
