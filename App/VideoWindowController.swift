...
final class VideoWindowController {
    ...
    /// Reference to PlaybackStore to sync showVideo state
    ...
    func show(
        ...
        playbackStore.videoWindowDidOpen()
    ...
    @objc private func windowWillClose(_ notification: Notification) {
        ...
        // Sync PlaybackStore state - this handles close via red button
        // This will trigger MainWindow.onChange which calls close(), but isClosing prevents re-entry
        if self.playbackStore?.showVideo == true {
    ...
    private func performCleanup() {
        // Clear grace period
        self.playbackStore?.videoWindowDidClose()
