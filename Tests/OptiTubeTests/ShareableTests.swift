...
struct ShareableTests {
    ...
    @Test("Track shareText includes title and artist")
    func trackShareText() {
        let track = Track(
            id: "test-track",
        ...
        #expect(track.shareText == "Never Gonna Give You Up by Rick Astley")
    }

    @Test("Track shareURL has correct format")
    func trackShareURL() {
        let track = Track(
            id: "test-track",
            title: "Test Track",
        ...
        #expect(track.shareURL?.absoluteString == "https://music.youtube.com/watch?v=dQw4w9WgXcQ")
    }

    @Test("Track with multiple artists displays comma-separated")
    func trackMultipleArtists() {
        let track = Track(
            id: "test-track",
        ...
        #expect(track.shareText == "Collaboration Track by Artist One, Artist Two, Artist Three")
    }
