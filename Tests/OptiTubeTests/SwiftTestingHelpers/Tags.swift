...
/// ```bash
/// # Run only API tests
/// xcodebuild test -scheme OptiTube -only-testing:OptiTubeTests --test-iterations 1 \
///   -test-tag .api
///
...
/// | `.service` | Service layer | `AuthServiceTests`, `PlaybackStoreTests` |
...
extension Tag {
    ...
    ///
    /// Use for: `AuthService`, `PlaybackStore`, `WebKitManager`.
    @Tag static var service: Self

    /// Tests related to data models.
    ///
    /// Use for: `Track`, `Playlist`, `Album`, `Artist`, enums, extensions.
