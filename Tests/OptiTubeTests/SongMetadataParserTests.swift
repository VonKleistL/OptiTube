...
/// Tests for TrackMetadataParser.
@Suite("TrackMetadataParser", .tags(.parser))
struct TrackMetadataParserTests {
    ...
    func parseTitleExtractsTitle() {
        let renderer: [String: Any] = [
            "title": [
                "runs": [
                    ["text": "Test Track Title"],
                ],
            ],
        ]

        let result = TrackMetadataParser.parseTitle(from: renderer)

        #expect(result == "Test Track Title")
    }
    ...
    func parseArtistsSingleArtist() {
        ...
        let artists = TrackMetadataParser.parseArtists(from: renderer)
    ...
    func parseThumbnailExtractsURL() {
        ...
        let url = TrackMetadataParser.parseThumbnail(from: renderer)
    ...
    func parseDurationExtractsDuration() {
        ...
        let duration = TrackMetadataParser.parseDuration(from: renderer)
    ...
    func parseMenuDataExtractsLikeStatus() {
        ...
        let result = TrackMetadataParser.parseMenuData(from: renderer)
    ...
    func extractPanelVideoRendererDirect() throws {
        ...
        let renderer = try TrackMetadataParser.extractPanelVideoRenderer(from: data, videoId: "test-video")
    ...
    func extractPanelVideoRendererWrapped() throws {
        ...
        let renderer = try TrackMetadataParser.extractPanelVideoRenderer(from: data, videoId: "wrapped-video")
    ...
    func extractPanelVideoRendererThrows() {
        ...
        #expect(throws: YTMusicError.self) {
            _ = try TrackMetadataParser.extractPanelVideoRenderer(from: data, videoId: "test")
        }
    }
