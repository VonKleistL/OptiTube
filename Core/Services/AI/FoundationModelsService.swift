...
final class FoundationModelsService {
    ...
    ///   with AI features. For OptiTube, we call this at launch since AI is a core feature.
    func warmup() async {
    ...
    /// Best for: natural language music commands like "play jazz" or "skip this track".
    ///
    /// - Parameters:
