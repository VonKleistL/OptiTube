...
/// Serializes to JSON in `~/Library/Application Support/OptiTube/scrobble-queue.json`.
...
final class ScrobbleQueue {
    ...
    /// - Parameter directory: Directory for queue file. Defaults to Application Support/OptiTube.
    ...
    private static func defaultDirectory() -> URL {
        ...
        return appSupport.appendingPathComponent("OptiTube")
    }
}
