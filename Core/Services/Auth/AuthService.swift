...
final class AuthService: AuthServiceProtocol {
    ...
    private var expiredSAPISID: String?
    ...
    /// Waits for initial cookie restore before evaluating login state.
    ...
    func completeLogin(sapisid: String) -> Bool {
        guard sapisid != self.expiredSAPISID else {
            self.logger.warning("Ignoring the credential from the expired session")
            return false
        }
