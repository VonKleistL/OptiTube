...
struct PlaylistDetail: Identifiable, Sendable {
    ...
    init(playlist: Playlist, tracks: [Track], duration: String? = nil) {
        self.id = playlist.id
...
// MARK: - LikedTracksResponse

/// Response from the liked tracks API, including pagination support.
struct LikedTracksResponse: Sendable {
    /// The liked tracks returned in this response.
    let tracks: [Track]
