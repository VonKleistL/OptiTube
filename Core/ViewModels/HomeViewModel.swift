...
final class HomeViewModel {
    ...
    @ObservationIgnored private let backgroundLoadTask = TaskBox<Void, Never>()
    ...
    func load(forceRefresh: Bool = false) async {
        ...
        self.logger.info("Loading home content (force: \(forceRefresh))")
    ...
    private func startBackgroundLoading() {
        self.backgroundLoadTask.replace(with: Task { [weak self] in
